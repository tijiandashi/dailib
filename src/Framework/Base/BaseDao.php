...
class BaseDao extends \Phalcon\Mvc\Model
{
    ...
    public function execute($sid, $param)
    {
        ...
        try{
            ...
            throw new DaiBkException(DaiBkException::INTER_ERROR, $e->getMessage());
        }
    ...
    private function querySql($pdo, $sqlPre, $binds)
    {
        ...
        try{
            ...
            throw new DaiBkException( DaiBkException::DB_ERROR, $e->getMessage() );
        }
    }
    ...
    public function execRaw($sql)
    {
        ...
        try{
            ...
            throw new DaiBkException( DaiBkException::DB_ERROR );
        }
    }
    ...
    public function trimBase($data)
    {
        ...
        $className = \DaiBk\Library\Annotations::getCommentValue($commentDao, "dataObject");
        ...
        foreach ( $reflection->getProperties() as $property) {
            ...
            $type = \DaiBk\Library\Annotations::getCommentValue($comment, 'type' );
